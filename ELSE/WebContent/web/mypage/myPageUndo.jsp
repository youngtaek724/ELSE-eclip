...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/myPage.css" crossorigin="anonymous"/>
        ...
        <!--footer ê´ë ¨ css-->
        <link href="${pageContext.request.contextPath}/assets/css/css/footer.css" rel="stylesheet">
                  ...
                  <!-- ì¤ìì ë¤ì´ê° ë´ì© -->
                    <div class="profile" id="mpDIV">
                        ...
                        <div style="margin-left: 3%; margin-right: 3%;float: left;" id="mpDIV">
                            <img src="../img\í¬ë.jpg" style="width: 300px; height: 200px;">
                        </div>
                        <div style="margin-bottom: 2%; height: 30%;" id="mpDIV">
                            <h2>í¬ë ë° ì¤ì¸ë¨¸ì¤ì¼ í¬ì¥</h2>
                            <div>
                            <p style="text-align: left; font-size: 15px;">ì¥ì : ê²½ê¸°ë ìì°ì ëë¶ë¶ë
                                <br> ë ì§ : 20xxë xxì xxì¼
                                <br> ìë¬´ìê° : 13ì ~ 17ì
                                <br> ìë¬´ê°ë : í
                                <br> ìë¬´ë´ì© : íì°ì¤ìì ìíí í¬ëì ì¤ì¸ë¨¸ì¤ì¼ì
                                <br> ì¢ì´í¬ì¥ì§ë¡ í¬ì¥í í í¬ì¥ë°ì¤ì ë´ê¸°</p>
                          </div>
