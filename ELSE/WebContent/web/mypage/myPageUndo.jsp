                  ...
                  <!-- 중앙에 들어갈 내용 -->
                    <div class="profile" id="mpDIV">
                        ...
                        <div style="margin-left: 3%; margin-right: 3%;float: left;" id="mpDIV">
                            <img src="../img\포도.jpg" style="width: 300px; height: 200px;">
                        </div>
                        <div style="margin-bottom: 2%; height: 30%;" id="mpDIV">
                            <h2>포도 및 샤인머스켓 포장</h2>
                            <div>
                            <p style="text-align: left; font-size: 15px;">장소 : 경기도 안산시 대부북동
                                <br> 날짜 : 20xx년 xx월 xx일
                                <br> 업무시간 : 13시 ~ 17시
                                <br> 업무강도 : 하
                                <br> 업무내용 : 하우스에서 수확한 포도와 샤인머스켓을
                                <br> 종이포장지로 포장한 후 포장박스에 담기</p>
                          </div>
