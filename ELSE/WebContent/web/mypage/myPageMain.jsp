...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/myPage.css" crossorigin="anonymous"/>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/css/header.css">
        <!--footer ê´ë ¨ css-->
        ...
        <div class="mypage" id="mpDIV">
          ...
          <!-- ììª½ ì§ìíí© -->
                  ...
                  <div class="profile" id="mpDIV">
                    ...
                    <h3 style="text-align: left; margin-left: 3%; font-size: 25px;">íê¸¸ëë, íìí©ëë¤.</h3>
                    <br>
                    <h2>ì ë¢°ì ì</h2>
                    <div style="display: flex; width: 90%; margin-left: 5%; margin-bottom: 3%;">
                    <li class="li1">20 â</li>
                    <li class="li2">40 â</li>
                    <li class="li3">60 â</li>
                    <li class="li4">80 â</li>
                    <li class="li5">100 â</li>
                    </div>
                    <br>
                    <h3>íìì´ì ì°¸ì¬í íìê° ëì ìë¡ ì ë¢°ì ìê° ëìµëë¤</h3>
                    <div class="last_join">
                        <h1>ìµê·¼ ì°¸ì¬í íìì´ íì¸íë¬ ê°ê¸° </h1>
                    </div>
                </div>
                <div class="profile" id="mpDIV">
                    <div style="margin-bottom: 5%;" id="mpDIV">
                    </div>
                    <h3 style="text-align: left; margin-left: 3%; font-size: 25px;">ë´ê° ë¨ê¸´ íê¸°</h3>
                    <div style="display: flex; width: 90%; margin-left: 5%; margin-bottom: 3%;">
                    <li style="margin-left: 4%;">
                        <img src="..\img\epliloge1.jpg" style="width: 250px; height: 300px;">
                        <h3 style="text-align: left;">ì´ì´ ì¼ìëê¸°</h3>
                        <p style="text-align: left;">2022.10.22</p>
                    </li>
                    <li style="margin-left: 4%;">
                        <img src="..\img\epliloge2.jpg" style="width: 250px; height: 300px;">
                        <h3 style="text-align: left;">ë´ì¬íë í ì¹êµ¬ë¤ê³¼</h3>
                        <p style="text-align: left;">2022.09.17</p>
                    </li>
                    <li style="margin-left: 4%;">
                        <img src="..\img\epliloge3.png" style="width: 250px; height: 300px;">
                        <h3 style="text-align: left;">íìì´ ë©¤ë²ë¤</h3>
