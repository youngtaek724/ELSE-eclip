          ...
          <!-- ììª½ ì§ìíí© -->
                  ...
                  <!-- ì¤ìì ë¤ì´ê° ë´ì© -->
                    <div class="profile" id="mpDIV">
                        ...
                        <h3 style="text-align: left; margin-left: 3%; font-size: 25px;">íê¸¸ëëì í¬ì¸í¸</h3>
                        ...
                        <div style="margin-bottom: 2%; height: 30%;" id="mpDIV">
                            ...
                            <p style="text-align: left; font-size: 20px;">
                                <br>
                                ëìë¬¸í ìíê¶ êµííê¸°
                                <br>
                                5,000ìê¶ í¹ì 10,000ìê¶ì¼ë¡ êµí ê°ë¥í©ëë¤.
                                <br>
                                    
                            </p>
                            <div style="text-align: right; margin-right: 10%; margin-bottom: 3%;" id="mpDIV">
                                <button>êµí ì ì²­</button>
                                </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div style="margin-bottom: 2%; height: 30%;" id="mpDIV">
                            ...
                            <div>
                                <p style="text-align: left; font-size: 20px;">
                                    ...
                                    ì§ì­íí êµííê¸°
                                    <br>
                                    1,000ìê¶, 5,000ìê¶, 10,000ìê¶ì¼ë¡ êµí ê°ë¥í©ëë¤.
