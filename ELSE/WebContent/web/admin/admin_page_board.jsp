...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/admin_page_board.css">
    ...
    <div id="base">
        <div class="main">
            <header class="top_header">
                <div class="headerbar">
                    <div class="admin_name">íìì´ ê²ìí</div>
            ...
            <div class="content">
                <div class="content_wrapper">
                    ...
                    <div class="user_list">
                        <div class="total_user">íìì´ ê²ìê¸
